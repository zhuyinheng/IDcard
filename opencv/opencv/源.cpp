...
*/
int main() {
	Mat image = imread("‪C:\\Users\\朱胤恒\\Desktop\\IMG_0672.JPG");
	CascadeClassifier cascade, nestedcascade;
	cascade.load("‪C:/opencv/opencv3.1.0/sources/data/haarcascades/haarcascade_frontalface_alt.xml");
	nestedcascade.load("‪C:/opencv/opencv3.1.0/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml");
